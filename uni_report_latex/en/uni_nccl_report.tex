...
This release happened well after the begin of this report, so the focus will be on version 5.
...
Along the logging profiler plugin, a visualization tool as been built, 
...
Next, when the application calls \texttt{ncclAllReduce},
