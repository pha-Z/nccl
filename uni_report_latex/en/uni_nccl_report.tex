...
\begin{itemize}
  ...
  \begin{itemize}
    \item sbatch run 1: 7.64µs overhead. averaged 26.40 µs per iter w/o. 34.04 µs w/ profiler 
  \end{itemize}

  \item p2p singlenode (1mil iters 100 warmup iters):
  \begin{itemize}
    \item sbatch run 1: 7.26µs overhead. averaged 26.66 µs per iter w/o. 33.92 µs w/ profiler 
  \end{itemize}

  \item commops singlenode (10000 iters, 100 warmup iters):
  \begin{itemize}
    \item sbatch run 1: check slurm 2697340 ...
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item sbatch run 1: check slurm 2697154 ...
  \end{itemize}
  ...
  \item commops multinode (10000 iters, 100 warmup iters):
  \begin{itemize}
    \item sbatch run 1: check slurm 2697341 ...
  \end{itemize}
\end{itemize}
