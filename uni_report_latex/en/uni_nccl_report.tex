...
\section{About NCCL}
% ---------------------------------------------------------------------------
NCCL\footnote{\url{https://github.com/NVIDIA/nccl}} (pronounced "Nickel") was first introduced by NVIDIA in 2015 at the Supercomputing Conference (SC15), with an accompanying presentation highlighting its optimized collectives for multi-GPU systems. 
...
Although substrate plugins primarily consume events, the plugin could use Score-P's user instrumentation API
