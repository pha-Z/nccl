...
where the mapping from ranks to devices is surjective. 
...
so the mapping from ranks to threads is also surjective.
\end{itemize}
...
\begin{figure}[H]
  ...
  The blue dotted lines indicate the parentObj of each proxyStep event, 
...
(e.g., \\\texttt{SCOREP\_EnterRegion} and \texttt{SCOREP\_ExitRegion} or \\\texttt{SCOREP\_USER\_REGION\_BY\_NAME\_BEGIN}/\texttt{END}).
