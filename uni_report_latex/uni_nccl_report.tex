...
\subsection{MPI}
\begin{itemize}
  \item Zentriert um CPU-Prozesse, die kommunizieren
  \item Ranks/Tasks pro CPU-Prozess
  \item Rank = CPU-Prozess
\end{itemize}

\subsection{NCCL}
\begin{itemize}
  \item Zentriert um GPUs, die kommunizieren; CPU-Prozesse/Threads orchestrieren
  \item Ranks/Tasks m\"oglicherweise pro CPU-Thread
  \item Ranks/Tasks ggf.\ einer GPU (oder vielen GPUs? TODO) zugeordnet
