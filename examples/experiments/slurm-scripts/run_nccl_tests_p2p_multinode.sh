#!/bin/bash
# NCCL Profiler overhead: P2P multi-node using NVIDIA nccl-tests (sendrecv_perf).
# Launch with srun. Build nccl-tests with: make MPI=1 ...
# nccl-tests: https://github.com/NVIDIA/nccl-tests

#SBATCH --job-name=nccl_tests_p2p_mn
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:15:00

#SBATCH -e err_nccl_tests_p2p_mn-%J
#SBATCH -o out_nccl_tests_p2p_mn-%J
...
echo "=========================================="
echo "NCCL Profiler Overhead - P2P (nccl-tests sendrecv_perf, multi-node)"
echo "=========================================="
...
RESULTS_DIR="nccl_tests_results_p2p_multinode_${SLURM_JOB_ID}"
mkdir -p "$RESULTS_DIR"

NITER=1000000
WARMUP=100
OPTS="-b 8 -e 64K -f 2 -g 1 -n $NITER -w $WARMUP"
