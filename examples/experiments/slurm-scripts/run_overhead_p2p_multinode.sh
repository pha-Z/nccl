...
#SBATCH -e err_overhead_p2p_multinode-%J
#SBATCH -o out_overhead_p2p_multinode-%J
...
EXE="${NCCL_PATH}/examples/experiments/02_p2p_overhead/p2p_overhead_mpi"

# Check if executable exists
if [ ! -f "$EXE" ]; then
    echo "ERROR: Executable not found. Please run 'make' in examples/experiments/02_p2p_overhead"
    exit 1
fi
