...
#SBATCH --job-name=profiler_01_communicators_single_process
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e err_profiler_01_communicators_single_process-%J
#SBATCH -o out_profiler_01_communicators_single_process-%J
...
EXAMPLE_DIR="${NCCL_PATH}/examples/01_communicators/01_multiple_devices_single_process"
EXAMPLE_EXE="${EXAMPLE_DIR}/multiple_devices_single_process"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-communicators-single-process-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_communicators_single_process_${SLURM_JOB_ID}"
