...
#SBATCH --job-name=profiler_05_symmetric_memory
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e err_profiler_05_symmetric_memory-%J
#SBATCH -o out_profiler_05_symmetric_memory-%J
...
EXAMPLE_DIR="${NCCL_PATH}/examples/05_symmetric_memory/01_allreduce"
EXAMPLE_EXE="${EXAMPLE_DIR}/allreduce_sm"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-symmetric-memory-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_symmetric_memory_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
