...
#SBATCH --job-name=profiler_07_interleaved
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e /slurm-logs/err_profiler_07_interleaved-%J
#SBATCH -o /slurm-logs/out_profiler_07_interleaved-%J
...
# Example executable
EXAMPLE_DIR="${NCCL_PATH}/examples/07_advanced_features/02_interleaved_computation_communication"
EXAMPLE_EXE="${EXAMPLE_DIR}/interleaved_example"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-interleaved-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_interleaved_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
