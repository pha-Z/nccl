...
#SBATCH --job-name=profiler_07_multi_gpu_per_task
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:2:00

#SBATCH -e /slurm-logs/err_profiler_07_multi_gpu_per_task-%J
#SBATCH -o /slurm-logs/out_profiler_07_multi_gpu_per_task-%J
...
echo "=========================================="
echo "NCCL multi-gpu-per-task (4 nodes, 4 GPUs each, 2 gpus/task)"
echo "=========================================="
...
# Executable
DIR="${NCCL_PATH}/examples/07_advanced_features/09_multi_gpu_per_task"
EXE="${DIR}/multi_gpu_per_task"
