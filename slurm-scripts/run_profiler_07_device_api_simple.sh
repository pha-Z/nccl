...
#SBATCH --job-name=profiler_07_device_api_simple
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e /slurm-logs/err_profiler_07_device_api_simple-%J
#SBATCH -o /slurm-logs/out_profiler_07_device_api_simple-%J
...
EXAMPLE_DIR="${NCCL_PATH}/examples/07_advanced_features/05_device_api_simple"
EXAMPLE_EXE="${EXAMPLE_DIR}/device_api_simple"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-device-api-simple-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_device_api_simple_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
