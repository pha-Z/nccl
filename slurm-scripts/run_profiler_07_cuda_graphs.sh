...
#SBATCH --job-name=profiler_07_cuda_graphs
...
# Example executable
EXAMPLE_DIR="${NCCL_PATH}/examples/07_advanced_features/01_cuda_graphs"
EXAMPLE_EXE="${EXAMPLE_DIR}/cuda_graphs_example"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-cuda-graphs-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_cuda_graphs_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
