...
#SBATCH --job-name=profiler_03_collectives
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e /slurm-logs/err_profiler_03_collectives-%J
#SBATCH -o /slurm-logs/out_profiler_03_collectives-%J
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-collectives-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_collectives_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
