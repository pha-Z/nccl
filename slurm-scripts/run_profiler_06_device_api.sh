...
#SBATCH --job-name=profiler_06_device_api
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e err_profiler_06_device_api-%J
#SBATCH -o out_profiler_06_device_api-%J
...
EXAMPLE_DIR="${NCCL_PATH}/examples/06_device_api/01_allreduce"
EXAMPLE_EXE="${EXAMPLE_DIR}/allreduce_device_api"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-device-api-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_device_api_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
