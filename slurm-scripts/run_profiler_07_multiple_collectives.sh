...
#SBATCH --job-name=profiler_07_multiple_collectives
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e /slurm-logs/err_profiler_07_multiple_collectives-%J
#SBATCH -o /slurm-logs/out_profiler_07_multiple_collectives-%J
...
#SBATCH --gres=gpu:4  # Single node, multiple GPUs
...
# Example executable
EXAMPLE_DIR="${NCCL_PATH}/examples/07_advanced_features/03_multiple_collectives_group"
EXAMPLE_EXE="${EXAMPLE_DIR}/multiple_collectives_group"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-multiple-collectives-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_multiple_collectives_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
