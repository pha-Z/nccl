...
#SBATCH --job-name=profiler_04_user_buffer
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e err_profiler_04_user_buffer-%J
#SBATCH -o out_profiler_04_user_buffer-%J
...
EXAMPLE_DIR="${NCCL_PATH}/examples/04_user_buffer_registration/01_allreduce"
EXAMPLE_EXE="${EXAMPLE_DIR}/allreduce_ub"
...
export NCCL_INSPECTOR_DUMP_DIR="nccl-inspector-user-buffer-${SLURM_JOB_ID}"
...
export NCCL_PROFILE_EVENT_MASK=4095
export NCCL_PROFILE_DUMP_FILE="nccl_example_plugin_user_buffer_${SLURM_JOB_ID}"
unset NCCL_INSPECTOR_ENABLE
unset NCCL_INSPECTOR_DUMP_DIR
unset NCCL_INSPECTOR_DUMP_VERBOSE
$EXAMPLE_EXE
