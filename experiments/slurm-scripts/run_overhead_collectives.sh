...
#SBATCH --job-name=overhead_collectives
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e /slurm-logs/err_overhead_collectives-%J
#SBATCH -o /slurm-logs/out_overhead_collectives-%J
...
echo "=========================================="
echo "NCCL Profiler Overhead - Collectives"
echo "=========================================="
...
EXE="${NCCL_PATH}/experiment/01_collectives_overhead/collectives_overhead"
