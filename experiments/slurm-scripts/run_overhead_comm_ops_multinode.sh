...
#SBATCH -e /slurm-logs/err_overhead_comm_ops_multinode-%J
#SBATCH -o /slurm-logs/out_overhead_comm_ops_multinode-%J
...
EXE="${NCCL_PATH}/experiment/03_comm_ops_overhead/comm_ops_overhead_mpi"
