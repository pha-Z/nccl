...
#SBATCH --job-name=overhead_collectives_multinode
#SBATCH --account=p_lv_nccl

#SBATCH --time=00:10:00

#SBATCH -e /slurm-logs/err_overhead_collectives_multinode-%J
#SBATCH -o /slurm-logs/out_overhead_collectives_multinode-%J
...
echo "=========================================="
echo "NCCL Profiler Overhead - Collectives (Multi-Node)"
echo "=========================================="
...
EXE="${NCCL_PATH}/experiment/01_collectives_overhead/collectives_overhead_mpi"

# Check if executable exists
if [ ! -f "$EXE" ]; then
    echo "ERROR: Executable not found. Please run 'make' in experiment/01_collectives_overhead"
    exit 1
fi
